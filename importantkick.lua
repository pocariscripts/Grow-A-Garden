-- Fake Ban Message Script - Roblox Disconnect Style
...
-- Create the fake disconnect GUI
local function createFakeDisconnectGui()
    ...
    overlay.BackgroundColor3 = Color3.fromRGB(57, 62, 70)
    ...
    disconnectFrame.Position = UDim2.new(0.5, -160, 0.5, -80)
...
local function showFakeDisconnect()
    ...
    disconnectFrame.Position = UDim2.new(0.5, -150, 0.5, -75)
...
print("Fake disconnect message loaded successfully!")
